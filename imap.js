	...
	function getLayers() {
		...
		baseMaps["OpenStreetMap"] = new L.tileLayer('http://{s}.tile.osm.org/{z}/{x}/{y}.png', {maxZoom:18, attribution: '&copy; <a href="http://osm.org/copyright">OpenStreetMap</a> contributors'});
		baseMaps["OpenCycleMap"] = new L.tileLayer('http://{s}.tile.opencyclemap.org/cycle/{z}/{x}/{y}.png', {maxZoom:18, attribution: 'Maps &copy; <a href="http://www.thunderforest.com">Thunderforest</a>, Data &copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors'});
		...
		baseMaps["Kosmosnimki.ru OSM"] = new L.tileLayer('http://{s}.tile.osm.kosmosnimki.ru/kosmo/{z}/{x}/{y}.png', {maxZoom:18, subdomains:'abcdef', attribution: 'Map Data: © <a href="http://osm.kosmosnimki.ru/" target="_blank">osm.kosmosnimki.ru</a>'});
	...
	function createPopup(host_id) {
		...
		var url = new Curl('portal.php?app=winbox&hostid='+host_id);
		rstr = rstr + '<a href="'+url.getUrl()+'" Title="Winbox"><img src="imap/images/winbox.png"></a>';
		var url = new Curl('portal.php?app=putty&hostid='+host_id);
		rstr = rstr + '<a href="'+url.getUrl()+'" Title="Putty"><img src="imap/images/putty.png"></a>';
		var url = new Curl('portal.php?app=winmtr&hostid='+host_id);
		rstr = rstr + '<a href="'+url.getUrl()+'" Title="Winmtr"><img src="imap/images/winmtr.png"></a>';
		var url = new Curl('portal.php?app=web&hostid='+host_id);
                rstr = rstr + '<a href="'+url.getUrl()+'" Title="Web"><img src="imap/images/web.png"></a>';
		var url = new Curl('portal.php?app=rdp&hostid='+host_id);
                rstr = rstr + '<a href="'+url.getUrl()+'" Title="Rdp"><img src="imap/images/rdp.png"></a>';
